...
public static class ThemeCatalog
{
    ...
    [
        ...
        // ── Status ───────────────────────────────────────────────────────
        new("chip-ok-bg",   "status", "OK-Chip Hintergrund",      "OK chip background",      "#1f4a1f"),
        new("chip-err-bg",  "status", "Fehler-Chip Hintergrund",  "Error chip background",   "#3d1f1f"),
        new("chip-warn-bg", "status", "Warn-Chip Hintergrund",    "Warning chip background", "#2d1f0a"),
        new("chip-info-bg", "status", "Info-Chip Hintergrund",    "Info chip background",    "#0d1f38"),
