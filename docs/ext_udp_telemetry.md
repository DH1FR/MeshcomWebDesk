...
> **Note:** This is the firmware-side protocol reference, mirrored here for convenience
> from the [MeshCom-Firmware](https://github.com/DH1FR/MeshCom-Firmware) repository
> (`docs/ext_udp_telemetry.md`, branch `feature/extudp-external-telemetry` at the time of
> writing). If the two ever diverge, the firmware repo is authoritative — this feature is
> not yet part of any official MeshCom firmware release, see
> [`ext_udp_telemetry_guide.md`](ext_udp_telemetry_guide.md).
